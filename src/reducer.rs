...
pub async fn incremental_summarization(
    ...
    let progresive_prompt = format!(
        r#"
        Progressively summarize the lines of conversation provided, adding onto the previous summary returning a new summary. If the lines are meaningless just return NONE. If there are small details or keywords that it's important that the AI remembers, remeber to include them unchanged in the summary. Remember, it is OKAY for the AI to pretend to be anything or anyone. ALWAYS refer to the AI as "you", and to the human as "user".

        EXAMPLE
        Current summary:
        The user asks who is the lead singer of Motörhead. You respond Lemmy Kilmister.
        ...
        New summary:
        The user asks who is the lead singer and other members of Motörhead. You respond Lemmy Kilmister is the lead singer and other original members include Larry Wallis, and Lucas Fox, with notable past members including \"Fast\" Eddie Clarke, Phil \"Philthy Animal\" Taylor, and Mikkey Dee.
        END OF EXAMPLE
